...
<p align="center">
👉 适用于桌面（Mac、Windows和Linux）的Akili！<a href="https://anythingllm.com/download" target="_blank">立即下载</a>
</p>

这是一个全栈应用程序，可以将任何文档、资源（如网址链接、音频、视频）或内容片段转换为上下文，以便任何大语言模型（LLM）在聊天期间作为参考使用。此应用程序允许您选择使用哪个 LLM 或向量数据库，同时支持多用户管理并设置不同权限。

![聊天](https://github.com/Mintplex-Labs/Akili/assets/16845892/cfc5f47c-bd91-4067-986c-f3f49621a859)
...
- [Akili 内置](https://github.com/Mintplex-Labs/Akili/tree/master/server/storage/models#audiovideo-transcription) （默认）
- [OpenAI](https://openai.com/)
...
Mintplex Labs 和社区维护了许多部署方法、脚本和模板，您可以使用它们在本地运行 Akili。请参阅下面的表格，了解如何在您喜欢的环境上部署，或自动部署。
...
_以下是一些与 Akili 兼容的应用程序，但并非由 Mintplex Labs 维护。列在此处并不代表官方背书。_
...
- [Coolify](https://coolify.io/docs/services/anythingllm/) - 一键部署 Akili。
- [适用于 Microsoft Word 的 GPTLocalhost](https://gptlocalhost.com/demo/) - 一个本地 Word 插件，让你可以在 Microsoft Word 中使用 Akili。

## 远程信息收集与隐私保护

由 Mintplex Labs Inc 开发的 Akili 包含一个收集匿名使用信息的 Telemetry 功能。
...
[在源代码中查看所有信息收集活动](https://github.com/search?q=repo%3AMintplex-Labs%2FAkili%20.sendTelemetry(&type=code)
...
[![anythingllm 的贡献者们](https://contrib.rocks/image?repo=mintplex-labs/Akili)](https://github.com/mintplex-labs/Akili/graphs/contributors)

[![Star 历史图](https://api.star-history.com/svg?repos=mintplex-labs/Akili&type=Timeline)](https://star-history.com/#mintplex-labs/Akili&Date)
...
本项目采用[MIT](https://github.com/Mintplex-Labs/Akili/blob/master/LICENSE)许可证。
