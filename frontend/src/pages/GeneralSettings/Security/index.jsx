...
function MultiUserMode() {
  ...
  const handleSubmit = async (e) => {
    ...
    setHasChanges(false);
    if (useMultiUserMode) {
      const form = e?.target ? new FormData(e.target) : new FormData(document.getElementById("multi-user-form"));
      const data = {
...
function PasswordProtection() {
  ...
  const handleSubmit = async (e) => {
    ...
    const form = e?.target ? new FormData(e.target) : new FormData(document.getElementById("password-form"));
