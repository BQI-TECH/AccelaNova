...
const EMBEDDERS = [
  {
    ...
    description: "Use the built-in embedding provider for Akili. Zero setup!",
  },
  {
    name: "OpenAI",
    value: "openai",
...
export default function EmbedderPanel() {
  ...
  const handleSubmit = async (e) => {
    e?.preventDefault();
    const form = e?.target || document.getElementById("embedding-form");
    if (
  ...
  return (
    <>
      ...
      >
        <div
          id="embedding-section"
          className="flex flex-col w-full px-1 md:pl-6 md:pr-[50px] pb-16 md:pb-6"
        >
