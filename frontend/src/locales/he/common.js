...
const TRANSLATIONS = {
    ...
    welcomeMessage: {
        part1: "ברוכים הבאים ל-Akili, כלי קוד פתוח מבית Mintplex Labs שהופך כל דבר לצ'אטבוט מאומן שאפשר לשאול ולשוחח איתו. Akili היא תוכנת BYOK (הבא-מפתחות-משלך) כך שאין מנוי, עמלה או חיובים עבור תוכנה זו מלבד השירותים שברצונך להשתמש בהם.",
