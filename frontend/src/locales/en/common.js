const TRANSLATIONS = {
    onboarding: {
        ...
        userSetup: {
            ...
            adminUsernameReq: "Username must be at least 6 characters long and only contain lowercase letters, numbers, underscores, and hyphens with no spaces.",
    ...
    welcomeMessage: {
        part1: "Welcome to Akili, an open-source AI tool by BQI-TECH that turns anything into a trained chatbot you can query and chat with. Akili is a BYOK (bring-your-own-keys) software so there is no subscription, fee, or charges for this software outside of the services you want to use with it.",
    ...
    customization: {
        ...
        items: {
            ...
            "welcome-messages": {
                ...
                description: "Customize the welcome messages displayed to your users. Only non-admin users will see these messages.",
                new: "New",
                system: "system",
                user: "user",
                message: "message",
    ...
    profile_settings: {
        ...
        username: "Username",
        username_description: "Username must only contain lowercase letters, numbers, underscores, and hyphens with no spaces",
    ...
    community_hub: {
        publish: {
            ...
            slash_command: {
                ...
                command_description: "This is the slash command that users will type to trigger this preset.",
