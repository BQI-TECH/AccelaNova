...
const TRANSLATIONS = {
    ...
    welcomeMessage: {
        part1: "Chào mừng đến với Akili, Akili is an open-source AI tool by BQI-TECH that turns anything into a trained chatbot you can query and chat with. Akili is a BYOK (bring-your-own-keys) software so there is no subscription, fee, or charges for this software outside of the services you want to use with it.",
    ...
    agent: {
        ...
        provider: {
            ...
            description: "Nhà cung cấp LLM & mô hình cụ thể sẽ được sử dụng cho @agent agent của workspace này.",
        },
        mode: {
            chat: {
                title: "Mô hình Chat cho Agent Workspace",
                description: "Mô hình chat cụ thể sẽ được sử dụng cho @agent agent của workspace này.",
            },
            title: "Mô hình Agent Workspace",
            description: "Mô hình LLM cụ thể sẽ được sử dụng cho @agent agent của workspace này.",
            wait: "-- đang chờ mô hình --",
        },
        skill: {
            title: "Kỹ năng agent mặc định",
            description: "Cải thiện khả năng tự nhiên của agent mặc định với những kỹ năng được xây dựng sẵn này. Thiết lập này áp dụng cho tất cả workspace.",
            rag: {
            ...
            view: {
                ...
                description: "Cho phép agent liệt kê và tóm tắt nội dung của các tệp workspace hiện đang được nhúng.",
            },
            scrape: {
            ...
            generate: {
                title: "Tạo biểu đồ",
                description: "Cho phép agent mặc định tạo các loại biểu đồ khác nhau từ dữ liệu được cung cấp hoặc đưa ra trong chat.",
            },
            save: {
                title: "Tạo & lưu tệp",
