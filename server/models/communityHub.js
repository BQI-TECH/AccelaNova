...
/**
 * An interface to the Akili Community Hub external API.
 */
const CommunityHub = {
     ...
     * so we can unzip and import them to the Akili instance.
    ...
    /**
     * Apply an item to the Akili instance. Used for simple items like slash commands and system prompts.
    ...
    /**
     * Import a bundle item to the Akili instance by downloading the zip file and importing it.
