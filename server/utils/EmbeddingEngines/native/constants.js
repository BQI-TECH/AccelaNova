const SUPPORTED_NATIVE_EMBEDDING_MODELS = {
    "Xenova/all-MiniLM-L6-v2": {
        ...
        apiInfo: {
            ...
            description: "A lightweight and fast model for embedding text. The default model for Accelanova.",
            lang: "English",
            size: "23MB",
    ...
    "Xenova/nomic-embed-text-v1": {
        ...
        embeddingMaxChunkLength: 16000,
        chunkPrefix: "search_document: ",
        queryPrefix: "search_query: ",
        apiInfo: {
            id: "Xenova/nomic-embed-text-v1",
            name: "nomic-embed-text-v1",
            description: "A high-performing open embedding model with a large token context window. Requires more processing power and memory.",
            lang: "English",
            size: "139MB",
    ...
    "MintplexLabs/multilingual-e5-small": {
        ...
        apiInfo: {
            ...
            description: "A larger multilingual embedding model that supports 100+ languages. Requires more processing power and memory.",
            lang: "100+ languages",
            size: "487MB",
